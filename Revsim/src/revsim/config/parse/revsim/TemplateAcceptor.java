...
public class TemplateAcceptor extends SequenceAcceptor {

	public TemplateAcceptor () {
		super(new OTAcceptor("template_t"),
	...
	public Acceptor factory () {
		return new TemplateAcceptor();
	}
	
	public String getAlias () {
		return this.getAcceptor(2).getText();
	}
